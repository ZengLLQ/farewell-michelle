...
const Scene = () => (
  <>
    ...
    <SilkBlob position={[2.6, -1.6, -2]} color="#7C6AE8" scale={3.4} speed={1.4} distort={0.45} drift={1} />
    <SilkBlob position={[-3.2, 1.8, -3.5]} color="#9B8CF0" scale={2.6} speed={1.1} distort={0.5} drift={-0.8} />
    <SilkBlob position={[0.4, -3.4, -4.5]} color="#5B4FC0" scale={3.8} speed={0.9} distort={0.38} drift={0.6} />
